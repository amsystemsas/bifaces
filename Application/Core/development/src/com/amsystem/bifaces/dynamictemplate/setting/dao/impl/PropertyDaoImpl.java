...
public class PropertyDaoImpl extends AbstractDao<Integer, Property> implements PropertyDao {
    ...
    /**
     * Actualiza los valores de una propieda
     *
    ...
    public boolean update(IFProperty property) {
        ...
        try{
            int update = jdbcTemplate.update(sql.toString(), property.getLabel(), property.getType(),
            ...
            flag = false;
            log.error("No se pudo eliminar la propiedad: " + property.getName() + "\t return: " + ex.getMessage());
        }
        return flag;
     ...
     * @param idProperty identificador de la propiedd
